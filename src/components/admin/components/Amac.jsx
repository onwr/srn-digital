...
const AmacPanel = () => {
    ...
    return (
        <div className='duration-300 container max-w-screen-lg w-full border bg-zinc-100 p-4 rounded-xl'>
            <p className='text-xl font-semibold'>Kullanım Amacını Güncelle</p>
            <form className='mt-3 w-full' onSubmit={handleSubmit}>
                ...
                />
                <button type="submit" className='p-2 mt-5 w-full bg-lime-400 text-white rounded-lg'>Kaydet</button>
            </form>
        </div>
    );
};
